...
def make_FHI_AIMS_calc_dir(atoms, calculation_dir, time_hrs,
...
def create_fhi_aims_ARCHER2_slurm_file(calculation_dir,time_hrs,project_name,default_slurm_file_path,qos='standard',n_tasks=128,num_nodes=1,budget_allocation='e05-surfin-mic'):
    """
